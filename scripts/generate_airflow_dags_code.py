...
TEMPLATE_FILES = {
    'etl_base': 'etl_base.py',
    'job_script': './template/job_script.txt',
    'spark_config': './airflow_templates/spark_config.txt',
    'dag_template': './airflow_templates/dag.txt',
    'container_operator': './airflow_templates/emrcontaineroperator.txt'
}
...
def main() -> None:
    ...
    if target_layers:
        ...
        print("Generating scripts for all layers: flatfile, bronze, silver, domain")
